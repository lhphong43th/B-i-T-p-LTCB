...
void copySoLeCuaMang (int mangA[],int soPhanTuTrongMangA, int mangB[], int *soPhanTuTrongMangB=0 );
void copySoAmCuaMang (int mangA[], int soPhanTuTrongMangA, int mangC[], int *soPhanTuTrongMangC=0 );
void copySoHoanHaoCuaMang (int mangA[], int soPhanTuTrongMangA, int mangD[], int *soPhanTuTrongMangD=0 );
